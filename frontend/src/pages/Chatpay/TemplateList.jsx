...
export default function TemplateList() {
  return (
    <EmptyStateCard 
      headerTitle="Daftar Template Pesan"
      emptyTitle="Anda belum memiliki Template"
      emptyDescription="Buat template pesan otomatis untuk mempermudah membalas chat atau mengirim tagihan."
      buttonText="Buat Template Baru"
      iconSvg={
      ...
      onAction={() => alert('Membuat Template...')}
    />
  );
}
